		...
		$(document)
				.ready(
						function() {
							...
							var table = document
									.getElementById('tabelaJednostkoweZuzycie'), options = {
								chart : {
									renderTo : 'wykresJednostkoweZuzycie',
									type : 'column'
								},
								title : {
									text : 'Jednostkowe zużycie'
								},
								xAxis : {
									max : 3
								},
...
<body>
	...
	<h2 align="center">Jednostkowe zużycie</h2>
...
group by nazwa, powierzchnia
	...
	<div style="width: 90%; margin-left: 5%">
		<table style="font-size: 12px" align="center" border="0"
			id="tabelaJednostkoweZuzycie" cellspacing="0px"
			class="table table-striped table-bordered" width="100%">
			<thead>
				<tr>
					<th style="text-align: center;">Nazwa</th>
					<th style="text-align: center;">Ciepło [GJ/m2]</th>
					<th style="text-align: center;">Energia [kWh/m2]</th>
					<th style="text-align: center;">Gaz [Nm3/m2]</th>
					<th style="text-align: center;">Woda [m3/m2]</th>
				</tr>
			</thead>
			<tbody>
	...
	<br></br>
	<div id="wykresJednostkoweZuzycie" style="width: 80%; margin: 10%"></div>
	<br></br>
