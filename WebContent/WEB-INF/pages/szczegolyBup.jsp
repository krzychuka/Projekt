...
<body>
	...
	<div style="width: 60%; margin-left: 20%">
		<table align="center" class="table table-striped table-bordered">
			<tr>
				<td>Nazwa</td>
				<td><form:form method="POST">${bup.nazwa}</form:form></td>
			</tr>
			<tr>
				<td>Adres</td>
				<td><form:form method="POST">${bup.adres}</form:form></td>
			</tr>
			<tr>
				<td>Powierzchnia</td>
				<td><form:form method="POST">${bup.powierzchnia}</form:form></td>
			</tr>
			<tr>
				<td>Liczba użytkowników</td>
				<td><form:form method="POST">${bup.liczbaUzytkownikow}</form:form></td>
			</tr>
		</table>
	</div>
			...
			<tbody>
				<c:forEach var="row" items="${bup.rows}">
					<tr>
						...
						<td align="center"><a
							href="editZuzycieBup.html?id=${row.zuzyciebupid}"
