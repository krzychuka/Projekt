...
<script>
	$(document).ready(function() {
		$("#tabelaCalkowiteKoszty, #tabelaCieplo").dataTable({
			"oLanguage" : {
				"sSearch" : "Szukaj:",
		...
		$(document)
				.ready(
						function() {
							...
							var table = document
									.getElementById('tabelaCalkowiteKoszty'), options = {
								chart : {
									renderTo : 'wykresCalkowiteKoszty',
									type : 'column'
								},
								title : {
									text : 'Całkowite koszty'
								},
								xAxis : {
									max : 3
								},
...
<body>
	...
	<h2 align="center">Całkowite Koszty</h2>

	<sql:query var="obiekt" dataSource="${postgres}">
select nazwa,
sum(cieploPLN) as "resultcieplo", sum(energiaPLN) as "resultenergia", sum(gazPLN) as "resultgaz", 
sum(wodaPLN) as "resultwoda" 
from obiekt
...
group by nazwa
	...
	<div style="width: 90%; margin-left: 5%">
		<table style="font-size: 12px" align="center" border="0"
			id="tabelaCalkowiteKoszty" cellspacing="0px"
			class="table table-striped table-bordered" width="100%">
			<thead>
				<tr>
					<th style="text-align: center;">Nazwa</th>
					<th style="text-align: center;">Ciepło [PLN]</th>
					<th style="text-align: center;">Energia [PLN]</th>
					<th style="text-align: center;">Gaz [PLN]</th>
					<th style="text-align: center;">Woda [PLN]</th>
				</tr>
			</thead>
			<tbody>
	...
	<br></br>
	<div id="wykresCalkowiteKoszty" style="width: 80%; margin: 10%"></div>
	<br></br>
