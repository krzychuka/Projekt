...
<body>
	...
	<div style="width: 60%; margin-left: 20%">
		<table align="center" class="table table-striped table-bordered">
			<tr>
				<td>Nazwa</td>
				<td><form:form method="POST">${urbisPwik.nazwa}</form:form></td>
			</tr>
			<tr>
				<td>Adres</td>
				<td><form:form method="POST">${urbisPwik.adres}</form:form></td>
			</tr>
			<tr>
				<td>Powierzchnia</td>
				<td><form:form method="POST">${urbisPwik.powierzchnia}</form:form></td>
			</tr>
			<tr>
				<td>Liczba użytkowników</td>
				<td><form:form method="POST">${urbisPwik.liczbaUzytkownikow}</form:form></td>
			</tr>
		</table>
	</div>
	...
	where urbisPwikId=${urbisPwik.id}
	</sql:query>

	<div style="width: 90%; margin-left: 5%">
		<table style="font-size: 12px" id="urbisPwikTable"
			class="table table-striped table-bordered" cellspacing="0"
			width="100%" align="center">
			<thead>
				<tr>
					<th style="display: none;">Id</th>
					<th style="display: none;">Urbis Pwik Id</th>
				...
				<c:forEach var="row" items="${urbisPwik.rows}">
					<tr>
						<td align="center" style="display: none;"><c:out
								value="${row.urbisPwikId}" /></td>
						<td align="center" style="display: none;"><c:out
								value="${row.zuzycieUrbisPwikId}" /></td>
						...
						<td align="center"><a
							href="editZuzycieUrbisPwik.html?id=${row.zuzycieUrbisPwikId}"
