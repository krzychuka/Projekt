		...
		<table style="font-size: 12px" id="odczytTable"
			...
			<thead>
				<tr>
					...
					<th><center>Ciepło [GJ]</center></th>
					<th><center>Energia [kWh]</center></th>
					<th><center>Gaz [Nm3]</center></th>
					<th><center>Woda [m3]</center></th>
			...
			<tbody>
				<c:forEach var="odczyt" items="${odczyty.rows}">
					<tr>
						<td style="display: none;"><c:out value="${odczyt.odczytid}" /></td>
						...
						<td align="center"><c:out value="${odczyt.cieplogj}" /></td>
						<td align="center"><c:out value="${odczyt.energiakwh}" /></td>
						<td align="center"><c:out value="${odczyt.gaznm3}" /></td>
						<td align="center"><c:out value="${odczyt.wodam3}" /></td>
