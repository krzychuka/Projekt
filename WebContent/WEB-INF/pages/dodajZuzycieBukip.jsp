...
select nazwa, bukipid from bukip
	...
	<h1 align="center">Dodaj zużycie Bukip</h1>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form:form class="form-horizontal" method="POST" id="contact-form"
					action="/Projekt/saveZuzycieBukip.html">
					<div class="control-group" style="display: none;">
						<form:label path="id" class="control-label col-md-offset-1">Id zużycie Bukip</form:label>
						<div class="controls col-md-offset-1">
							<form:input class="form-control" path="id"
								value="${zuzycieBukip.id}" readonly="readonly" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label col-md-offset-1">Bukip nazwa</label>
						<div class="controls col-md-offset-1">
							<%-- <form:input class="form-control" path="beanBupId" value="${zuzycieBup.beanBupId}"  /> --%>
							<select name="bukipNazwa" id="srt" class="form-control">
					...
					<div class="control-group" style="display: none;">
						<form:label path="beanBukipId" class="control-label col-md-offset-1">Bukip id</form:label>
						<div class="controls col-md-offset-1">
							<form:input class="form-control" path="beanBukipId"
								value="${zuzycieBukip.beanBukipId}" id="srt1"></form:input>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls col-md-offset-1">
							<form:input class="form-control" path="finalne"
								value="${zuzycieBukip.finalne}"></form:input>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls col-md-offset-1">
							<form:input class="form-control" path="sO2"
								value="${zuzycieBukip.sO2}"></form:input>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls col-md-offset-1">
							<form:input class="form-control" path="nox"
								value="${zuzycieBukip.nox}"></form:input>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls col-md-offset-1">
							<form:input class="form-control" path="cO2"
								value="${zuzycieBukip.cO2}"></form:input>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls col-md-offset-1">
							<form:input class="form-control" path="pyl"
								value="${zuzycieBukip.pyl}"></form:input>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls col-md-offset-1">
							<form:input class="form-control" path="cO"
								value="${zuzycieBukip.cO}"></form:input>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls col-md-offset-1">
							<form:input class="form-control" path="baP"
								value="${zuzycieBukip.baP}"></form:input>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group" style="display: none;">
						...
						<div class="controls col-md-offset-1">
							<form:input class="form-control" path="rok" id="inputRok"
								value="${zuzycieBukip.rok}"></form:input>
						</div>
					</div>
