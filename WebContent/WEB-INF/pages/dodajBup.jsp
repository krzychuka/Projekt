...
<body>
	...
	<h1 align="center">Dodaj Bup</h1>
	<div class="container-fluid col-md-offset-3 col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">Dodaj Bup</h3>
			</div>
			<div class="panel-body">
				<form:form class="form-horizontal" method="POST" id="contact-form"
					action="/Projekt/saveBup.html">
					<div class="control-group" style="display: none">
						<form:label path="id" class="control-label">Id bup</form:label>
						<div class="controls">
							<form:input path="id" value="${bup.id}" readonly="readonly" />
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls col-md-offset-1">
							<form:input class="form-control" type="text"
								path="liczbaUzytkownikow" value="${bup.liczbaUzytkownikow}" />
						</div>
					</div>
